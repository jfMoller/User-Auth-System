  ...
  <div class="bg-gray-900 text-white max-h-screen flex items-center justify-center">
    <div>
      <ul class="p-4 mb-4 rounded">
        <li class="bg-gray-800 cursor-pointer hover:bg-gray-700 border border-gray-900 m-2 px-2 py-1 rounded" v-for="product in products" :key="product.id">
...
export default {
  ...
  methods: {
    ...
    async editProduct(productId) {
      // Logic for editing the product with given productId
    },
